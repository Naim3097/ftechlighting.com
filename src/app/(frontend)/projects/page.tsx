...
const projectsFallback = [
  {
    ...
    number: '01',
    title: 'Aria<br>KLCC',
    image: '/assets/sections/projects/aria klcc kuala lumpur.jpg',
  ...
  },
  {
    ...
    image: '/assets/sections/projects/mercedes showroom puchong.webp',
  ...
  },
  {
    ...
    image: '/assets/sections/projects/autohaus setia alam selangor.jpg',
  ...
  },
  {
    ...
    number: '05',
    title: 'Sime<br>Darby',
    image: '/assets/sections/projects/sime darby business centre singapore.webp',
    location: 'Singapore',
  ...
  },
  {
    ...
    image: '/assets/sections/projects/akasa cheras south balakong.jpg',
  ...
  },
  {
    ...
    image: '/assets/sections/projects/one @ changi city singapore.jpg',
    location: 'Singapore',
  ...
  },
  {
    ...
    image: '/assets/sections/projects/cmc materials singapore.jpeg',
    location: 'Singapore',
  ...
  {
    id: 'hap-seng-industrial-park',
    number: '09',
    title: 'Hap Seng<br>Industrial Park',
    image: '/assets/sections/projects/hap seng industrial park selangor.jpg',
    location: 'Selangor',
  ...
  },
  {
    ...
    image: '/assets/sections/projects/singapore botanic gardens bukit timah gate.jpg',
    location: 'Singapore',
...
export default async function ProjectsPage() {
  ...
  const projectFallbackBySlug = Object.fromEntries(projectsFallback.map((f) => [f.id, f]));

  const projects = docs.length > 0
    ? docs.map((doc, i) => {
        const fb = projectFallbackBySlug[doc.slug];
        return {
          id: doc.slug,
          ...
          scope: doc.scope || categoryLabels[doc.category] || doc.category,
